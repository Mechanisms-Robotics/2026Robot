...
public class CONSTANTS {
    ...
    public static final Transform3d CAMERA1_TRANSFORM3D = new Transform3d(
        Units.inchesToMeters(0), // forward distances from the center of the robot
        Units.inchesToMeters(11.5), // leftward distance from the center of the robot
    ...
    public static final Transform3d CAMERA2_TRANSFORM3D = new Transform3d(
        Units.inchesToMeters(0), // figure out these
